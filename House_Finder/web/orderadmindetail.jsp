                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <c:if test="${order.status == 3 }">
                                                Status :  <label style="color: red">Canceled</label>
                                            </c:if>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title"><span>Renter Details</span></h5>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <c:forEach items="${account}" var="a">
                                                <c:if test="${order.userID == a.userID}">
                                                    <label>Renter Name : ${a.firstName} ${a.lastName}</label>
                                                </c:if>
                                            </c:forEach>
                                        </div>
                                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title"><span>House Order Details</span></h5>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <c:forEach items="${house}" var="h">
                                                <c:if test="${order.houseID == h.houseID}">
                                                    <img src="${h.image}" alt="alt" style="width: 100%; height: 500px"/>
                                                </c:if>
                                            </c:forEach>
