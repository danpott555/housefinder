                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <div class="actions" style="display: inline-flex;">
                                                            <a href="./vieworderadmindetail?id=${o.orderID}" class="btn btn-sm bg-success-light mr-2" style="margin-left: 10px">
