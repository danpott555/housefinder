                    ...
                    <div class="loginbox">
                        ...
                        <div class="login-right">
                            <div class="login-right-wrap">
                                ...
                                <p class="account-subtitle">Enter your email to get a password code</p>
                                <p class="account-subtitle" style="color: red">${alertMess}</p>   
                                <form action="forgotpassword" method="post">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="email" placeholder="Email" value="<c:out value='${param.email}'/>" required>
                                    </div>
