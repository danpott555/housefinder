                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <form action="viewuserprofile" method="post">
                                                            <div class="row">
                                                                ...
                                                                <p class="col-sm-9"><span class="form-control-plaintext">${acc.email}</span></p>
                                                            </div>
                                                            <div class="row">
                                                                <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">First Name:</p>
                                                                <p class="col-sm-9"><span class="form-control-plaintext">${acc.firstName}</span></p>
                                                            </div>
                                                            <div class="row">
                                                                <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Last Name:</p>
                                                                <p class="col-sm-9"><span class="form-control-plaintext">${acc.lastName}</span></p>
                                                            </div>
                                                            <div class="row">
                                                                <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Date of Birth:</p>
                                                                <p class="col-sm-9"><span class="form-control-plaintext">${acc.dob}</span></p>
                                                            </div>
                                                            <div class="row">
                                                                <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Mobile:</p>
                                                                <p class="col-sm-9"><span class="form-control-plaintext">${acc.phone}</span></p>
                                                            </div>
                                                            <div class="row">
                                                                <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Address:</p>
                                                                <p class="col-sm-9"><span class="form-control-plaintext">${acc.address}</span></p>
                                                            </div>
